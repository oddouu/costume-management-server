  ...
  if (req.isAuthenticated()) {
    ...
    Project.create({
      ...
      .then((createdProject) => {
        ...
        console.log({
          message:
            "1. I created the project and, depending on the user input, I pre-filled the arrays for Characters and Scenes.",
        ...
        Scene.create(emptyScenesArray)
          .then((createdScenes) => {
            ...
            console.log({
              message:
                "2. Depending on the Scenes array that I pre-filled in step 1, I created as many documents as needed within the Scene collection. Using the callback function of the document creation, I also created an array with newly created Scenes Ids - which will be later attached to the Project.",
              createdScenes,
              scenesIdArr,
            });
            Character.create(emptyCharactersArray)
              .then((createdCharacters) => {
                ...
                console.log({
                  message:
                    "3. Depending on the Character array that I pre-filled in step 1, I created as many documents as needed within the Character collection. Using the callback function of the document creation, I also created an array with newly created Character Ids - which will be later attached to the Project.",
                  createdCharacters,
                  charIdArr,
                });
                ...
                Project.findByIdAndUpdate(createdProjectId, {
                  ...
                  .then((updatedProject) => {
                    console.log({
                      message:
                        "4. I went back to the Project and updated it with the ids of the newly created Scenes and Characters.",
                      updatedProject,
                    });
